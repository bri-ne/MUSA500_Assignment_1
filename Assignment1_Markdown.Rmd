...
model. The parameters of multiple regression are coefficients β~0~ ,...,
β~k~, where k = number of predictors. β~0~ represents the y- intercept of
the regression line. β~1~ ... β~k~ represent the coefficients of variables
...
The least squares estimates for β̂\_0,..., β ̂\_k are obtained when the quantity for 
...
which is Β~i~ ≠ 0 for each predictor.
